...
import cn.com.wx.wheelview.adapter.BaseWheelAdapter;
import cn.com.wx.wheelview.adapter.SimpleWheelAdapter;
import cn.com.wx.wheelview.common.WheelConstants;
import cn.com.wx.wheelview.common.WheelViewException;
import cn.com.wx.wheelview.graphics.DrawableFactory;
import cn.com.wx.wheelview.util.WheelUtils;
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == WheelConstants.WHEEL_SCROLL_HANDLER_WHAT) {
                ...
                Log.e("mjoinwh",mJoinWheelView==null?"true":mJoinWheelView.getTag()+"");
...
//            throw new WheelViewException("join map data is error.");
        ...
        WheelView.this.postDelayed(new Runnable() {
            @Override
            public void run() {
                Log.e("resetDataFromTop",String.valueOf(getTag())+":"+temp.size()+"");
                setWheelData(temp);
    ...
    public void setSelection(final int selection) {
        Log.e("visible",String.valueOf(getTag())+":"+getVisibility());
...
//            throw new WheelViewException("wheel datas are error.");
        ...
        mList = list;
        if (mWheelAdapter != null) {
            Log.e("setWheelData",String.valueOf(getTag())+":"+list.size()+"列表");
    ...
    private void refreshCurrentPosition(boolean join) {
        ...
        Log.e("refreshCurrentPosition",String.valueOf(getTag())+firstPosition+"");
        ...
        Log.e("mHandler",getTag()+"####mHandler:success");
