...
public class TimePickerDialog extends DialogFragment implements View.OnClickListener {
    ...
    */
    void sureClicked() {
        ...
        int y = mTimeWheel.getCurrentYear();
        int m = mTimeWheel.getCurrentMonth() - 1;
        int d = mTimeWheel.getCurrentDay();
        int h = mTimeWheel.getCurrentHour();
        int mm = mTimeWheel.getCurrentMinute();
